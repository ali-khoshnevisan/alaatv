...
import { Authenticated, IncompleteProfile, showStudyPlan } from './middleware/middleware.js'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('src/pages/Public/ContactUs/ContactUs.vue')
          },
          {
            path: 'product',
            name: 'Public.Product',
          ...
          {
            name: 'Public.Pay',
            path: 'pay/:transaction_id/:user_id',
            layoutConfig: {
              layoutFooter: false,
              layoutFooterVisible: false
            },
            component: () => import('src/pages/Public/Pay.vue')
          },
          {
            path: 'checkout',
