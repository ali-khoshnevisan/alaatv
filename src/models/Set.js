...
class Set extends Model {
  constructor (data) {
    super(data, [
      ...
      { key: 'id', validate: { type: 'number', canBeNull: false, canBeEmpty: false } },
      { key: 'active_contents_count' },
      { key: 'author' },
      { key: 'apiUrl' },
      { key: 'contentUrl', validate: { type: 'string', canBeNull: false, canBeEmpty: false } },
      {
        key: 'contents',
        relatedModel: ContentList,
        validate: { type: 'object', canBeNull: true, canBeEmpty: false }
      },
      { key: 'pamphlets_count' },
      { key: 'videos_count' },
      { key: 'contents_count' },
      ...
      { key: 'description' },
      { key: 'photo' },
      { key: 'redirect_url', validate: { type: 'string', canBeNull: true, canBeEmpty: false } },
      { key: 'setUrl' },
      { key: 'title' },
      { key: 'short_title' },
      { key: 'order' },
