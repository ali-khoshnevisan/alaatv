    ...
    <div class="cart-items">
      <q-card class="cart-card">
        ...
        <q-card-section class="card-section">
          <div v-if="orderedItem.photo"
               class="order-image-section">
            <lazy-img height="96px"
                      width="96px"
                      :src="orderedItem.photo" />
          </div>
          ...
          <div class="product-text-info">
            <div class="order-item-header">
              <div class="title">
                ...
                <q-badge v-if="orderedItem.expire_at"
                         color="orange">
                  منقضی شده در:
                  {{ orderedItem.shamsiDate('expire_at').dateTime }}
                </q-badge>
              </div>
              <div v-if="isAdmin"
                   class="action">
                <q-btn icon="ph:trash"
                       ...
                       flat
                       @click="orderProductId(orderedItem.id)" />
              </div>
            </div>
            <div class="price-container">
              <div v-if="orderedItem.price.discountInPercent()"
                   class="discount-part">
                <div class="discount-percent">
                  {{ orderedItem.price.discountInPercent() }}%
                </div>

                <div class="base-price">
                  {{ orderedItem.price.toman('base', null) }}
                </div>
              </div>

              <div class="final-part">
                <div class="final-price">
                  {{ orderedItem.price.toman('final', null) ? orderedItem.price.toman('final', null) : 0}}
                </div>
