...
export default {
  ...
  data () {
    ...
    return {
      foreColor: '#000000',
      fontFamily: '',
      fontOptions: ['Doran', 'IRANSans', 'IRANSansDN', 'IRANSansX', 'iranyekan', 'Plasma', 'Panchang', 'Modam', 'YekanBakhFaNum'],
      editorToolbar: [
        [
          {
          ...
          },
          {
            ...
            list: 'no-icons',
            class: 'font',
            options: ['Doran', 'IRANSans', 'IRANSansDN', 'IRANSansX', 'iranyekan', 'Plasma', 'Panchang', 'Modam', 'YekanBakhFaNum']
          },
          {
