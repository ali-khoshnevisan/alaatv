    ...
    <template #main-tab>
      <div class="option-panel-container">
        ...
        <div class="row q-col-gutter-md">
          <div class="col-3">
            <q-input v-model="localOptions.backgroundColor"
                     label="background Color" />
          </div>
          <div class="col-3">
            <q-input v-model="localOptions.nameColor"
                     label="name Color" />
          </div>
          <div class="col-3">
            <q-input v-model="localOptions.majorColor"
                     label="major Color" />
          </div>
          <div class="col-3">
            <q-input v-model="localOptions.rankColor"
                     label="rank Color" />
          </div>
          <div class="col-3">
            <q-input v-model="localOptions.messageColor"
                     label="message Color" />
          </div>
        </div>
      </div>
