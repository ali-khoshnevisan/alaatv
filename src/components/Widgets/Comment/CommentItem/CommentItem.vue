...
$nameColor: v-bind('localOptions.nameColor');
$backgroundColor: v-bind('localOptions.backgroundColor');
$majorColor: v-bind('localOptions.majorColor');
$rankColor: v-bind('localOptions.rankColor');
$messageColor: v-bind('localOptions.messageColor');
