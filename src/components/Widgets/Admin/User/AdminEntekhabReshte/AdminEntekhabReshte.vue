  ...
  data () {
    return {
      ...
      konkurKarnameInputs: [
        ...
        { type: 'input', name: 'nomre_taraz_dey', label: 'نمره تراز اردیبهشت (اختیاری)', responseKey: 'nomre_taraz_dey', placeholder: ' ', col: 'col-6' },
      ...
      entekhabReshteInputs: [
        ...
        { type: 'input', name: 'mobile', label: 'شماره همراه', placeholder: ' ', col: 'col-6' },
        { type: 'input', name: 'phone', label: 'تلفن ثابت (با کد شهر)', placeholder: ' ', col: 'col-6' },
  ...
  methods: {
    ...
    getEntekhabReshte () {
      ...
      return new Promise((resolve, reject) => {
        ...
        APIGateway.user.getEntekhabReshteByUserId(userId, eventId)
    ...
    afterLoadEntekhabReshteInputs () {
      ...
      FormBuilderAssist.setAttributeByName(this.entekhabReshteInputs, 'mobile', 'value', this.fieldSelectionForm.user.mobile)
      FormBuilderAssist.setAttributeByName(this.entekhabReshteInputs, 'phone', 'value', this.fieldSelectionForm.user.phone)
