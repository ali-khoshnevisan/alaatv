          ...
          <q-expansion-item expand-separator
            ...
            <q-form ref="fieldForm"
              ...
              <div class="row q-col-gutter-sm">
                ...
                <div class="col-4">
                  <q-input v-model="localOptions.inputBorder"
                           type="text"
                           label="input border" />
                </div>
                <div class="col-4">
                  <q-input v-model="localOptions.inputLabelColor"
                           type="text"
                ...
                <div class="col-2">
                  <q-checkbox v-model="inputForm.required"
                              label="required" />
                </div>
                <div class="col-2">
                  <q-btn color="primary"
            ...
            <q-list v-if="localOptions.inputs.length > 0"
              ...
              <q-expansion-item v-for="(item, index) in localOptions.inputs"
                ...
                <div class="row q-col-gutter-sm">
                  ...
                  <div class="col-4">
                    <q-checkbox v-model="localOptions.inputs[index].required"
                                label="required" />
                  </div>
                </div>
...
export default defineComponent({
  ...
  data () {
    return {
      ...
      inputForm: { type: '', inputType: '', name: '', outlined: false, label: '', placeholder: '', col: '', required: true },
      typeOptions: [
        {
          label: 'متن',
          value: 'input'
  ...
  computed: {
    ...
    inputFormRequierd () {
      return this.inputForm.required
    }
  },
  watch: {
  ...
  methods: {
    ...
    addField () {
      ...
      this.inputForm = { type: '', name: '', outlined: false, label: '', placeholder: '', col: '', required: true }
    },
    deleteField (index) {
