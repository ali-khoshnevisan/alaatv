  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'select', name: 'major_id', behavior: 'menu', label: 'رشته', col: 'col-6' },
        { type: 'select', name: 'region_id', behavior: 'menu', label: 'سهمیه', col: 'col-6' },
        { type: 'separator', name: 'separator', label: 'تراز کنکور', size: '0', ignoreValue: true, col: 'col-12' },
        { type: 'input', name: 'nomre_taraz_dey', label: 'نمره تراز اردیبهشت (اختیاری)', col: 'col-6' },
        { type: 'input', name: 'nomre_taraz_tir', label: 'نمره تراز تیر (اختیاری)', col: 'col-6' },
        { type: 'input', name: 'nomre_taraz_moadel', label: 'نمره تراز معدل', col: 'col-6' },
        { type: 'input', name: 'nomre_taraz_kol', label: 'نمره تراز کل', col: 'col-6' },
        { type: 'separator', name: 'separator', label: 'رتبه کنکور', size: '0', ignoreValue: true, col: 'col-12' },
        { type: 'input', name: 'rank', label: 'رتبه کشوری', col: 'col-6' },
        { type: 'input', name: 'participationCode', label: 'کد داوطلبی (اختیاری)', col: 'col-6' },
        { type: 'input', name: 'rank_in_district', label: 'رتبه در منطقه', col: 'col-6' },
        { type: 'input', name: 'rank_in_region', label: 'رتبه در سهمیه', col: 'col-6' },
        { type: 'separator', name: 'separator', label: 'محل سکونت', size: '0', ignoreValue: true, col: 'col-12' },
        { type: 'select', name: 'province', behavior: 'menu', label: 'استان', optionLabel: 'title', optionValue: 'id', col: 'col-6' },
        { type: 'select', name: 'shahr_id', behavior: 'menu', label: 'شهر', optionLabel: 'title', optionValue: 'id', col: 'col-6' },
        { type: 'input', name: 'postalCode', label: 'کد پستی', col: 'col-12' },
        ...
        { type: 'file', name: 'reportFile', label: 'اسکن یا تصویر با کیفیت کارنامه خودتو بارگذاری کن.', col: 'col-xs-12 col-md-6' },
        ...
        { type: 'input', name: 'comment', label: 'توضیحات بیشتر', inputType: 'textarea', col: 'col-12' },
