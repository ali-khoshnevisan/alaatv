  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'file', name: 'file', label: 'یه فایل ترجیحا PDF که شامل رشته های منتخب شما باشه.', value: null, col: 'col-12' },
        ...
        { type: 'input', name: 'comment', label: 'توضیحات تکمیلی', inputType: 'textarea', value: null, col: 'col-12' },
        { type: 'separator', name: 'separator', label: 'اطلاعات تماس', size: '0', ignoreValue: true, col: 'col-12' },
        { type: 'input', name: 'mobile', label: 'شماره همراه', disable: true, col: 'col-6' },
        { type: 'input', name: 'phone', label: 'تلفن ثابت (با کد شهر)', value: null, col: 'col-6' },
        ...
        { type: 'select', name: 'majors', label: 'رشته ها', multiple: true, behavior: 'menu', showNoOption: false, createNewValue: true, newValueMode: 'add-unique', useChips: true, hideDropdownIcon: true, className: 'hidden', value: [], col: 'col-12' },
        ...
        { type: 'input', name: 'consultant_firstname', label: 'نام', value: null, col: 'col-6' },
        { type: 'input', name: 'consultant_lastname', label: 'نام خانوادگی', value: null, col: 'col-6' },
        { type: 'input', name: 'consultant_mobile', label: 'شماره تماس', value: null, col: 'col-12' }
      ]
    }
  },
  computed: {
