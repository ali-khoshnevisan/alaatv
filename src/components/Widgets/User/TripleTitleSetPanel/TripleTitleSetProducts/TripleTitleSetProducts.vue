...
export default {
  ...
  methods: {
    ...
    loadData () {
      ...
      APIGateway.events.getEventMajors(this.event.id)
        .then((majors) => {
          this.productTypeOptions = majors.list
          this.productType = this.productTypeOptions[0]
          this.getAdvisor()
      ...
      // let params
      // if (this.$route.params.eventName === 'haftane') {
      //   params = ['majorsRT']
      // } else if (this.$route.params.eventName === '110') {
      //   params = ['majorEnsani']
      // } else {
      //   params = ['majors']
      // }
      ...
      // }).then(res => {
      //   if (this.$route.params.eventName === 'haftane') {
      //     this.productTypeOptions = res.majorsRT
      //   } else if (this.$route.params.eventName === '110') {
      //     this.productTypeOptions = res.majorEnsani
      //   } else {
      //     this.productTypeOptions = res.majors
      //   }
      //   if (this.$route.params.eventName === 'emtehan-nahaee-10' ||
      //     this.$route.params.eventName === 'emtehan-nahaee-11' ||
      //     this.$route.params.eventName === 'emtahan-nahaee' ||
      //     this.$route.params.eventName === 'emtehan-nahaee--11') {
      //     this.productTypeOptions.forEach(option => {
      //       if (option.id === 3) {
      //         option.title = 'عمومی'
      //       }
      //     })
