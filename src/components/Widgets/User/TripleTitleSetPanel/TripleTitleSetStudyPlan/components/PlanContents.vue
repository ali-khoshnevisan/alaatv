...
export default {
  ...
  mounted () {
    this.fillEducationalLayers()
  },
  methods: {
    fillEducationalLayers () {
      const gamMehvar = ['گام اول', 'گام دوم', 'گام سوم']
      const farsangMehvar = ['فرسنگ اول', 'فرسنگ دوم', 'فرسنگ سوم']
      const khanMehvar = ['خان اول', 'خان دوم', 'خان سوم']
      if (this.educationalLayersType === 'gam_mehvar') {
        this.educationalLayers = gamMehvar
      } else if (this.educationalLayersType === 'farsang_mehvar') {
        this.educationalLayers = farsangMehvar
      } else if (this.educationalLayersType === 'khan_mehvar') {
        this.educationalLayers = khanMehvar
      }
