        ...
        <q-list class="menu-items q-mt-md">
          ...
          <q-item v-ripple
            ...
            <q-item-section class="menu-item-custom">
              ...
              <div class="menu-item-title q-ml-sm">فیلم ها و جزوه های من</div>
            </q-item-section>
          </q-item>
          <q-item v-ripple
                  clickable
          ...
          <q-item v-ripple
            ...
            <q-item-section class="menu-item-custom">
              <div class="bookmark">
                <q-icon name="ph:heart"
                        size="22px" />
              </div>
              <div class="menu-item-title q-ml-sm">علاقه مندی های من</div>
            </q-item-section>
          </q-item>
          <q-item v-ripple
                  clickable
                  :to="{name: 'UserPanel.index'}"
                  :active="isRouteSelected('UserPanel.index')">
            <q-item-section class="menu-item-custom">
              <q-icon name="ph:chalkboard-simple"
                      size="22px" />
              <div class="menu-item-title q-ml-sm">داشبورد دوره های آلاء</div>
            </q-item-section>
          </q-item>
          <!--          <q-item v-ripple-->
          <!--                  clickable-->
          <!--                  :to="{name: 'UserPanel.EntekhabReshte'}"-->
          <!--                  :active="isRouteSelected('UserPanel.EntekhabReshte')">-->
          <!--            <q-item-section class="menu-item-custom">-->
          <!--              <q-icon name="ph:books"-->
          <!--                      size="22px" />-->
          <!--              <div class="menu-item-title q-ml-sm">انتخاب رشته</div>-->
          <!--            </q-item-section>-->
          <!--          </q-item>-->
          <q-item v-ripple
                  clickable
                  :to="{name: 'UserPanel.Asset.GiftCard.MyGiftCards'}">
            <q-item-section class="menu-item-custom">
              <q-icon name="ph:gift"
                      size="22px" />
              <div class="menu-item-title q-ml-sm">کارآفرینی</div>
            </q-item-section>
          </q-item>
          <!--          <q-item v-ripple-->
          <!--                  clickable-->
          ...
          <q-item v-if="!isEwanoUser && !isRubikaUser"
                  v-ripple
                  clickable
                  @click="logout">
            <q-item-section class="menu-item-custom">
...
import { mixinWidget, mixinAuth, mixinRubika, mixinEwano } from 'src/mixin/Mixins.js'

export default {
  name: 'ProfileMenu',
  components: { LazyImg },
  mixins: [mixinWidget, mixinAuth, mixinEwano, mixinRubika],
  data () {
    return {
