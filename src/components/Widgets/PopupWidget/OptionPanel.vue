    ...
    <option-panel-tabs v-model:options="localOptions">
      <template #main-tab>
        <div class="option-panel-container">
          <div class="row q-col-gutter-sm q-my-sm">
            ...
            <div class="col-12 col-md-2">
              ...
              <q-checkbox v-model="localOptions.closeButton"
                          label="closeButton" />
              <q-checkbox v-model="localOptions.justImage"
                          label="just image"
                          @update:model-value="updateJustImage" />
          ...
          <q-expansion-item v-if="localOptions.justImage"
                            label="image">
            <image-widget-option-panel v-model:options="localOptions.imageOptions" />
          </q-expansion-item>
...
export default defineComponent({
  ...
  methods: {
    updateJustImage (value) {
      if (value) {
        this.localOptions.hasBody = this.localOptions.hasHeader = this.localOptions.hasAction = false
      }
    },
