            ...
            <div class="installment-roules-and-conditions">
              ...
              <div class="installment-roules-and-conditions-body">
                <div class="installment-roules-and-conditions-content">
                  ...
                  <br><br class="gt-md">
                  ۴. 10% مالیات بر ارزش افزوده در قیمت محصول لحاظ شده است.
                </div>
                <div class="
          ...
          <div v-if="paymentMethod !== 'cash'"
            ...
            <div class="installment">
              <q-list class="installment-list">
                ...
                <q-item class="installment-footer justify-between">
                  <q-item-section class="installment-footer-label"
                                  side>
                    مجموع
                  </q-item-section>
                  <q-item-section v-if="productPrice.discount_instalmentally > 0"
...
export default defineComponent({
  ...
  methods: {
    ...
    loadProductInfo () {
      this.productPrice = new Price(this.product.price)
    ...
    removeProductFromCart (productData) {
      return new Promise((resolve, reject) => {
        this.$store.dispatch('Cart/removeItemFromCart', { product: productData })
          .then(() => {
            resolve()
          })
          .catch(() => {
