<template>
  <div class="option-panel-container">
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12">
        <q-input v-model="localOptions.options.productTabsBorder"
                 label="Tabs Border" />
      </div>
      <div class="col-12">
        <q-checkbox v-model="localOptions.options.showSelectBox"
                    label="show select box" />
      </div>
      <div v-if="localOptions.options.showSelectBox"
           class="col-12">
