...
import ThemeHaftaneh from 'components/Product/ProductItem/Themes/themeHaftaneh.vue'
import themeTelescope from 'components/Product/ProductItem/Themes/themeTelescope.vue'
...
export default defineComponent({
  ...
  methods: {
    ...
    addToCart () {
      if (!this.isUserLogin && this.product.price?.fixDiscountPercentage) {
        this.$store.commit('Cart/updateDraftProduct', this.product)
