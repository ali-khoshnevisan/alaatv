...
export default defineComponent({
  ...
  data () {
    return {
      themeOptions: [
        { title: 'بدون دکمه ثبت نام', value: 'ThemeDefault' },
        { title: 'با دکمه ثبت نام', value: 'ThemeProduct1' },
        { title: 'قدیمی', value: 'ThemeProduct2' },
        { title: 'تلسکوپ', value: 'themeTelescope' },
        { title: 'قدم بعدی', value: 'ThemeProduct3' },
        { title: 'هفتانه', value: 'themeHaftaneh' }
      ],
      ...
      fontFamilyOptions: ['iranyekan', 'IRANSans', 'IRANSansXFaNum', 'IRANSansDN', 'Doran FaNum', 'ModamFaNumWeb', 'Panchang', 'Plasma-Lozenge-Dots', 'YekanBakhFaNum'],
      defaultOptions: {
        theme: 'ThemeDefault',
