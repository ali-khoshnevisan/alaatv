    ...
    <template #main-tab>
      <div class="option-panel-container">
        <div class="row q-mt-sm">
          ...
          <div class="col-xs-12 q-my-md">
            <q-checkbox v-model="localOptions.generateByMajor"
                        label="show text by major" />
            <div v-if="localOptions.generateByMajor">
              <q-input v-for="text in localOptions.majorGradeTexts"
                       :key="text.major_id"
                       v-model="text.text"
                       class="q-my-sm"
                       :label="text.label" />
...
export default defineComponent({
  name: 'OptionPanel',
  components: { Editor, OptionPanelTabs, EditorOptions, LazyImg, SeparatorOptionPanel },
