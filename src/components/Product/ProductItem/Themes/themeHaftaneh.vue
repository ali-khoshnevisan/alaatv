<template>
  <div class="theme-haftaneh"
    ...
    <product-discount-badge class="product-discount-badge horizontal-mode"
                            :src="'https://nodes.alaatv.com/upload/alaaPages/2024-07/Star1721915343.png'"
    ...
    <div class="product-content-box"
      ...
      <router-link :to="getRoutingObject"
                   @click="productClicked">
        <div class="title-box main-title ellipsis-1-lines"
             :class="[localOptions.theme]">
          {{ product.title }}
          <q-tooltip>
            {{ product.title }}
