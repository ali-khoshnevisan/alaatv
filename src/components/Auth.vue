    ...
    login () {
      ...
      this.$store.dispatch('Auth/login', {
        ...
        .then(({ accessToken, user }) => {
          ...
          //   })
          this.$store.commit('AppLayout/updateLoginDialog', false)
          const draftProduct = this.$store.getters['Cart/draftProduct']
          if (draftProduct.id) {
            this.$store.dispatch('Cart/addToCart', { product: draftProduct })
              .then(() => {
                this.$store.commit('Cart/updateDraftProduct', new Product())
