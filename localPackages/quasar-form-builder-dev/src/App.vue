    ...
    return {
      ...
      inputs: [
          ...
          value: [
            ...
            },
            {
              ...
              value: [
                ...
                {
                  type: 'link',
                  url: 'https://nodes.alaatv.com/media/c/pamphlet/1374/Sefr_Ta_Sad_Fizik12_Konkor_Yari.pdf',
                  value: 'link without label',
                  col: 'col-md-6'
                }
              ]
            }
        ...
        },
        {
          ...
          rules: [(val) => !!val || 'field is required'],
          // lazyRules: true,
          outsideLabel: 'time with placeholder(Enter)',
          multiple: false,
          responseKey: 'test2',
          value: '19:00:00',
          outlined: true,
        ...
        {
          type: 'image',
          value: 'https://nodes.alaatv.com/upload/tempPrivate/userReports/1720451325_3323.jpg',
          width: '100px',
          height: '100px',
          label: 'image',
          col: 'col-md-6'
